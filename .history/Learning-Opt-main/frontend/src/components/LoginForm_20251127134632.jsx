    ...
    <form onSubmit={handleLogin} className="space-y-6 w-full max-w-md">
      <div>
        <input
          ...
          disabled={isLoading}
          className="w-full p-4 rounded-md bg-[#89CFF1]-800 text-white placeholder:text-zinc-400 focus:ring-2 focus:ring-violet-500"
        />
      </div>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 text-[#003A6B]-300 hover:text-white-400 select-none"
        >
