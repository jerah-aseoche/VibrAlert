    ...
    <form onSubmit={handleLogin} className="space-y-6 w-full max-w-md">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-300 hover:text-blue-400 select-none"
        >
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full bg-[c6EB1D6]-600 hover:bg-[c6EB1D6]-700 transition p-4 rounded-md text-zinc font-semibold"
      >
