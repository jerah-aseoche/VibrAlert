...
function DetectionLogs() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden text-white">
      ...
      {/* ─── TOP BAR ─────────────────────────────────────── */}
      <header className="relative z-10 w-full h-14 flex items-center justify-between px-6 bg-[#185886]/90 shadow-md">

        <button
          onClick={goHome}
          className="text-white font-semibold hover:text-[#6EB1D6] transition"
        >
          ← Home
        </button>
