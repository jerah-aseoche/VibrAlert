...
export default function ManualControl() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col text-white">
      ...
      {/* ─── TOP HEADER ──────────────────────────────────── */}
      <header
        className={`relative z-10 w-full h-16 flex items-center justify-between px-6 shadow-md border-2 border-${colors.secondary.replace("#","")} rounded-md`}
      >
        <button
          onClick={goHome}
          className="text-white font-semibold hover:text-[#dbeafe] transition"
        >
          ← Home
        </button>
