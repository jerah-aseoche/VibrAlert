...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#185886] text-white-400 flex flex-col">
        ...
        <div className="bg-[#6EB1D6] rounded-xl p-10 shadow-xl text-center flex flex-col items-center w-full max-w-6xl">
          ...
          <div className="mt-10 flex gap-10">
            ...
            <button
              ...
              className="w-48 h-48 border border-[#6EB1D6] rounded-lg flex items-center justify-center text-xl hover:bg-white hover:text-black transition-all"
            >
              Manual Control
            </button>
