...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-[#003A6B] p-6">
      {isLoading && <LoadingSpinner overlay size={50} color="white" />}

      {/* Center Container */}
      <div className="w-full max-w-[500px] bg-[#89CFF1] rounded-xl shadow-xl p-10 flex flex-col items-center text-center">
